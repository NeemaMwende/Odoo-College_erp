...
class accountConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        partial_budget_approve = self.env['ir.config_parameter'].sudo().get_param('partial_budget_approve')
        res.update(
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('partial_budget_approve', self.partial_budget_approve)
